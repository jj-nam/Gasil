				...
				<div class="collapse navbar-collapse" id="navbarText">
					...
					<span class="navbar-text"> 
						<c:choose>
							...
							<c:otherwise>
								<a class="nav-link active" aria-current="page" href="/message_list.do"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-dots" viewBox="0 0 16 16">
